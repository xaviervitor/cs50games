...
function love.update(dt)
    ...
    -- movement. The paddle waits for the distance between the ball and
    -- the center of the paddle to be greater than paddleMoveThreshold
    if player2YCenterPos - ball.y > paddleMoveThreshold or ball.y - player2YCenterPos > paddleMoveThreshold then
        -- Catch up with the ball
        if player2YCenterPos > ball.y then
            player2.dy = -PADDLE_SPEED
        elseif player2YCenterPos < ball.y then
            player2.dy = PADDLE_SPEED
        end
    else
        player2.dy = 0
